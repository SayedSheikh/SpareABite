...
const Hero = () => {
  ...
  console.log(theme);
  return (
    <section className=" w-11/12  max-w-[1400px] mx-auto mt-10">
        ...
        <div className="space-y-8 animate-fade-in flex-1">
          <div className="space-y-4">
            ...
            <p
              ...
              }  text-xl lg:text-2xl leading-relaxed max-w-xl`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              size="lg"
              className="btn btn-primary p-6 text-lg font-semibold rounded-full transition-all duration-300 flex items-center">
              Start Sharing
            ...
            <button
              variant="outline"
              size="lg"
              className="btn btn-outline btn-primary p-6 text-lg font-semibold rounded-full transition-all duration-300">
              Find Food Near Me
            </button>
          </div>
        </div>
